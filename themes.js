...
const themes = {
  ...
  HWTheme: {
    ...
    rules: [
      ...
      {token: "markup.deleted", foreground: "ff0000", fontStyle: "bold"},
      {token: "markup.inserted", foreground: "1db010", fontStyle: "bold"},
      ...
      {token: "hide", foreground: "34373b"},
      {token: "delimiter", foreground: "34373b"},
      {token: "cond", foreground: "ce63eb"},
